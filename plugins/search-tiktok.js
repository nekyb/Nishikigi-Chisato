...
import { generateWAMessageFromContent, proto } from '@soblend/baileys';
...
const tiktokSearchCommand = {
  ...
  async execute(sock, msg, args) {
    ...
    try {
          ...
          if (videoMsg && videoMsg.message && videoMsg.message.videoMessage) {
            const card = {
              ...
              body: proto.Message.InteractiveMessage.Body.create({
                text: `👤 ${result.author || 'Usuario'}\n❤️ ${result.likes || 0} likes`
              }),
      ...
      try {
        const carouselMessage = generateWAMessageFromContent(chatId, {
          viewOnceMessage: {
            message: {
              messageContextInfo: {
                deviceListMetadata: {},
