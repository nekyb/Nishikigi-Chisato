...
const wikipediaCommand = {
    ...
    async execute(sock, msg, args) {
        ...
        try {
            ...
            const headers = {
                'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) NishikigiBot/1.0 (+https://github.com/nekyb/Nishikigi-Chisato)',
            ...
            if (imageUrl) {
                // Intentar descargar la imagen con headers personalizados para evitar 403
                try {
                    const imgHeaders = {
                        'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) NishikigiBot/1.0 (+https://github.com/nekyb/Nishikigi-Chisato)',
                        'Accept': 'image/*,*/*;q=0.8'
                    }
                    const imgResp = await axios.get(imageUrl, { responseType: 'arraybuffer', headers: imgHeaders, timeout: 15000 })
