...
⚡ 𝘗𝘰𝘸𝘦𝘳𝘦𝘥 𝘣𝘺 𝘋𝘦𝘭𝘵𝘢𝘉𝘺𝘵𝘦`
            ...
            const animeImageUrl = typeof output === 'string' ? output : output[0]
            const animeImageResponse = await axios.get(animeImageUrl, { responseType: 'arraybuffer' })
...
⚡ 𝘗𝘰𝘸𝘦𝘳𝘦𝘥 𝘣𝘺 𝘋𝘦𝘭𝘵𝘢𝘉𝘺𝘵𝘦`,
                contextInfo: {
                    externalAdReply: {
                        ...
                        thumbnailUrl: "https://i.ibb.co/9yKF5xF/anime-style.jpg",
