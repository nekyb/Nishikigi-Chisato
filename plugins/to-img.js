const toimgCommand = {
    ...
    async execute(sock, msg, args) {
        ...
        try {let stickerMessage = msg.message?.stickerMessage
            ...
            if (!stickerMessage) {return await sock.sendMessage(chatId, {
            ...
            await sock.sendMessage(chatId, {
                image: buffer,
                caption: '《✧》 ✅ *Convertido a imagen*'}, { quoted: msg })} catch (error) {console.error('Error en toimg:', error)
            await sock.sendMessage(chatId, {
