...
const delinearCommand = {
    ...
    async execute(sock, msg, args) {
        ...
        try {
            ...
            const imageMessage =
                msg.message?.imageMessage || quotedMsg?.imageMessage;

            if (!imageMessage) {
                return await sock.sendMessage(chatId, {
                    text:
                        `《✧》 *Delineador de Imágenes* 《✧》\n\n` +
            ...
            try {
                ...
                try {
                    ...
                    console.log(
                        "ClipDrop falló, usando procesamiento local...",
                    );
            ...
            if (!processedImage) {
                throw new Error(
                    "No se pudo procesar la imagen con ningún método",
                );
            }
            ...
            if (error.message?.includes("timeout")) {
                errorMessage +=
                    "⏱️ El procesamiento tardó demasiado.\n" +
...
async function processWithClipdrop(imageBuffer) {
    const CLIPDROP_KEY =
        "1a936d1e2f23decaa0638273e4ac65c754194792c360f79de928e992ce2791029f0f19bfc15aa37a061ff6a5a465c999"; // Obtener en clipdrop.co/apis

    if (
        !CLIPDROP_KEY ||
        CLIPDROP_KEY ===
            "1a936d1e2f23decaa0638273e4ac65c754194792c360f79de928e992ce2791029f0f19bfc15aa37a061ff6a5a465c999"
    ) {
