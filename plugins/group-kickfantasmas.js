...
export default {
    ...
    async execute(sock, msg, args) {
        ...
        try {
            console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━');
            console.log('🚨 DEBUG [KICKFANTASMAS]: Iniciando limpieza');
            ...
            // Crear un Set con usuarios activos
            ...
            // Encontrar fantasmas (no-admins inactivos)
            ...
            if (ghosts.length === 0) {
                console.log('✅ DEBUG: No hay fantasmas para expulsar');
                console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━');
            ...
            console.log('⚡ DEBUG: Iniciando expulsión masiva...');
            
            let kicked = 0;
            let failed = 0;

            // Expulsar de 5 en 5 para evitar rate limits
            ...
            console.log('✅ DEBUG: Expulsados exitosamente:', kicked);
            console.log('❌ DEBUG: Fallos:', failed);
            console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━');
            ...
            console.error('━━━━━━━━━━━━━━━━━━━━━━━━━━━');
            console.error('❌ ERROR [KICKFANTASMAS]:', error.message);
